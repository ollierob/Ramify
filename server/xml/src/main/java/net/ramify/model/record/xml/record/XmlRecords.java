...
@XmlSeeAlso({XmlMentionRecords.class, XmlResidenceRecords.class, XmlBurialRecords.class, XmlCensusRecords.class, XmlMemorialInscriptions.class, XmlBirthRecords.class})
