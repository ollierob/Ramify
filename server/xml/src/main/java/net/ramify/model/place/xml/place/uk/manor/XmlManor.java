...
public class XmlManor extends XmlRegion<Manor> {
    ...
    @Override
    protected Manor toPlace(final PlaceGroupId groupId, final PlaceHistory history, final PlaceParserContext context) throws Place.InvalidPlaceTypeException {
        return new Manor(this.placeId(context), this.name(), groupId, history);
    }
