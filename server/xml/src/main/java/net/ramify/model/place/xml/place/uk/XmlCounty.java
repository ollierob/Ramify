...
class XmlCounty extends XmlPlace {
    ...
    @Override
    protected County toPlace(final PlaceGroupId groupId, final PlaceHistory history, final PlaceParserContext context) throws Place.InvalidPlaceTypeException {
        return new County(this.placeId(context), this.name(), this.iso(), groupId, history);
    }
