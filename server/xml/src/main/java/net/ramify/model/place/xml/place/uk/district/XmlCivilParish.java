...
public class XmlCivilParish extends XmlRegion<CivilParish> {
    ...
    @Override
    protected CivilParish toPlace(final PlaceGroupId groupId, final PlaceHistory history, final PlaceParserContext context) throws Place.InvalidPlaceTypeException {
        return new CivilParish(this.placeId(context), this.name(), groupId, history);
    }
