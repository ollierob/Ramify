...
class PlaceTypeDescriptions {
    ...
    static {
        ...
        descriptions.put(PlaceProto.PlaceType.CHAPELRY, ENGLAND, "A _chapelry_ was a subdivision of a parish, consisting of one or more townships, and centered around a *chapel of ease* (church).");
        descriptions.put(PlaceProto.PlaceType.TOWNSHIP, ENGLAND, "An English _township_ was a rural subdivision of a parish or a chapelry. It was frequently (but not necessarily) centered around a town or village.");
