...
public class Mill extends AbstractPlace implements Institution {
    ...
    public Mill(final PlaceId id, final String name, final Place parent) throws InvalidPlaceTypeException {
        this(id, name, parent.requireAs(SettlementOrRegion.class));
    }

    public Mill(final PlaceId id, final String name, final SettlementOrRegion parent) {
        super(id, name);
