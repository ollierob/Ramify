...
public class Church extends AbstractPlace implements Institution {

    private final SettlementOrRegion parent;

    public Church(final PlaceId id, final String name, final Place parent, final PlaceGroupId groupId) throws InvalidPlaceTypeException {
        this(id, name, parent.requireAs(SettlementOrRegion.class), groupId);
    }

    public Church(final PlaceId id, final String name, final SettlementOrRegion parent, final PlaceGroupId groupId) {
