...
public interface BaptismRecord extends SingleFamilyRecord, HasPlaceId {
    ...
    default RecordProto.Record.Builder toProtoBuilder() {
        return SingleFamilyRecord.super.toProtoBuilder().setType(EventProto.RecordType.BAPTISM);
    }
